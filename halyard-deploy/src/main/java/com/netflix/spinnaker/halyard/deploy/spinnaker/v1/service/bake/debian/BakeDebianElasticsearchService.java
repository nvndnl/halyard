...
@Data
@Component
public class BakeDebianElasticsearchService extends ElasticsearchService implements BakeDebianService<ElasticsearchService.Elasticsearch> {
  @Autowired
  ArtifactService artifactService;

  StartupPriority priority = new StartupPriority(StartupPriority.MODERATE);

  final String upstartServiceName = "elasticsearch";

  @Override
  public ServiceSettings buildServiceSettings(DeploymentConfiguration deploymentConfiguration) {
    return new Settings()
        .setArtifactId("elasticsearch")
        .setEnabled(true);
  }
